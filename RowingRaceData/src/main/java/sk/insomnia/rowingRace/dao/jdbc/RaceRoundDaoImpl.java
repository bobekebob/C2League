...
public class RaceRoundDaoImpl implements RaceRoundDao {
    ...
    public RaceRound getById(Long id) throws SQLException, ConnectivityException {
        ...
        if (rs.next()) {
            ...
            DisciplineDaoImpl d = new DisciplineDaoImpl();
            raceRound.setDiscipline(d.getById(rs.getLong("DISCIPLINE_FK")));
