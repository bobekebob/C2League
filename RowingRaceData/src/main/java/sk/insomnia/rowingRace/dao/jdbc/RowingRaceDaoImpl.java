...
public class RowingRaceDaoImpl implements RowingRaceDao {
    ...
    public RowingRace getRowingRace(List<EnumEntity> raceCategories) throws SQLException,
        ...
        rs.beforeFirst();
        RaceRoundDaoImpl rDao = new RaceRoundDaoImpl();
        RaceCategoryDao raceCategoryDao = new RaceCategoryDaoImpl();
        while (rs.next()) {
            ...
            while (rs2.next()) {
                ...
                ry.getRounds().add(rDao.getById(rs2.getLong("RACE_ROUND_ID")));
            }
